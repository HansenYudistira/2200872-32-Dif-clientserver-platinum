...
function RegisterPage() {
    return (
        ...
        <div>
            ...
            <Input type="email" name="email" id="email" placeholder="EMAIL" required style={{border: "1px solid black"}}/>
        </div>
        <div>
        ...
        <div>
            ...
            <Input type="password" name="confirm_password" id="confirm_password" placeholder="CONFIRM PASSWORD" required style={{border: "1px solid black"}}/>
        </div>
